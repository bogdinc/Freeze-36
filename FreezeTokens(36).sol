...
contract FreezeTokens_36_Month is Context, Ownable {
    ...
    constructor (address _owner, address _token) Ownable(_owner) {
        ...
        emit SetParameter(0, 60*60*24*30*36, freezePeriod, seek, "set freezePeriod & seek");
        freezePeriod = 0;
        seek = 60*60*24*30*36;

        emit SetParameter(1, 1, numerator, denominator, "set numerator & denominator");
        numerator = 1;
        denominator = 1;
    }
